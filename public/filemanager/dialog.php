...
?>
<?php
$remPerc = round(($countDirSize->size / DIRECTORY_SIZE_LIMIT) * 100);
...
if ($countDirSize->size < DIRECTORY_SIZE_LIMIT) {
?>          
    <div style="width:100%;text-align:center;font-style:italic;font-size:12px;font-weight: bold">Wykorzystano <?php echo $countDirSize->format_size() . ' ' . DIRECTORY_SIZE_WORD . ' ' . $countDirSize->format_size(DIRECTORY_SIZE_LIMIT); ?></div>
<?php
}
else {
?>
    <div style="width:100%;text-align:center;font-style:italic;font-size:12px;font-weight: bold">Brak miejsca na dysku! Usuń niepotrzebne pliki.</div>
<?php
}
?>
<div class="progress">
  <div class="progress-bar progress-bar-<?php echo $barStyle; ?>" role="progressbar" aria-valuenow="<?php echo $remPerc; ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $remPerc; ?>%">
